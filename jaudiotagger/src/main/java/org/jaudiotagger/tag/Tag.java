...
public interface Tag {
    ...
    /**
     * Retrieve the first frame that exists for this identifier, and return the frame's text encoding
     *
     * @param id
     * @return See <ul><li>{@link TextEncoding#ISO_8859_1 }</li><li>{@link TextEncoding#UTF_16}</li><li>{@link TextEncoding#UTF_16BE}</li><li>{@link TextEncoding#UTF_8}</li></ul>
     */
    int getFirstFrameEncoding(FieldKey id) throws KeyNotFoundException;
